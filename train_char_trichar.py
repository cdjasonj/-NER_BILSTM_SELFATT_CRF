from neuralnets.char_trichar_bilstm import BiLSTM
import json
import math
import numpy as np
...
import logging
from tools.load_word2vec import get_char_embedding_matrix,get_trichar_embedding_matrix
...
# bichar_embedding_matrix = get_char_embedding_matrix(bichar2id)
...
def fit(params,dev_data,test_data):
    ...
    char_lstm = BiLSTM(char_embedding_matrix,trichar_embedding_matrix,params)
