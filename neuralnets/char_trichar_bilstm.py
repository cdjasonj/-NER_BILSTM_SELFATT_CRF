...
class BiLSTM:
    def __init__(self,char_embedding,trichar_embedding,params=None):
    ...
    def build_model(self):
        ...
        inputNodes = [tokens_input,trichar_input]
        ...
        embedding = Concatenate(axis=-1)([char_embedding,trichar_embedding])
