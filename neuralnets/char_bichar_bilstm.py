...
class BiLSTM:
    def __init__(self,char_embedding,bichar_embedding,params=None):
    ...
    def build_model(self):
        ...
        inputNodes = [tokens_input,bichar_input]
        ...
        embedding = Concatenate(axis=-1)([char_embedding,bichar_embedding])
